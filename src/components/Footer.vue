  ...
  <footer class="foot">
    <div class="container">
      ...
      <nav class="foot__legal" aria-label="Legal">
        <a href="https://lemur.legal/en/privacy_policy">{{ c.footer.legal.privacy }}</a>
        <a href="https://lemur.legal/en/terms_of_use">{{ c.footer.legal.terms }}</a>
        <a href="https://lemur.legal/en/cookie_policy">{{ c.footer.legal.cookie }}</a>
      </nav>
      <div class="foot__base">
        <span>{{ c.footer.copyright }}</span>
        <span>{{ c.footer.strap }}</span>
        <span class="lang">
