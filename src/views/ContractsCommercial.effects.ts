  ...
  try {
    ...
    (function(){
      ...
      $('[data-anim="nd"]').forEach(function(el,i){
        var c = el.getAttribute('data-nd-color') || '#137A5F';
        __fx.anim(el, [
      ...
      $('[data-anim="cpulse"]').forEach(function(el){
        el.style.cssText = 'position:absolute;top:0;left:-40%;width:40%;height:100%;background:linear-gradient(90deg,transparent,rgba(19,122,95,.8),transparent);pointer-events:none;';
        __fx.anim(el, [
      ...
      $('[data-anim="glitch"]').forEach(function(el){
        ...
        var ov1 = makeOv('#137A5F'), ov2 = makeOv('#1FC49A');
        function cycle(){
          var period = 3200;
          setTimeout(function(){
            __fx.anim(ov1, [
      ...
      $('[data-anim="mesh"]').forEach(function(cv){
        ...
        function rosette(cx,cy,s,Rr,rr,d,turns,ph,a){
          ...
          ctx.globalAlpha=a; ctx.strokeStyle='rgba(19,122,95,1)'; ctx.lineWidth=0.6; ctx.stroke(); ctx.globalAlpha=1;
        }
        function size(){
        ...
        function frame(){
          ...
          for(var w=0;w<wires.length;w++){
            ...
            ctx.globalAlpha=L.a; ctx.strokeStyle='rgba(19,122,95,1)'; ctx.lineWidth=0.7; ctx.stroke(); ctx.globalAlpha=1;
          }
          for(var i=0;i<motes.length;i++){
            var mo=motes[i]; mo.y-=mo.vy; if(mo.y<-3){ mo.y=H+3; mo.x=R(0,W); }
            ctx.globalAlpha=mo.a; ctx.fillStyle='rgba(19,122,95,1)';
      ...
      $('[data-ht-hover-fill]').forEach(function(b){
        ...
        __fx.on(b, 'mouseenter', function(){
          ...
          if (isOutline){ b.style.backgroundColor = '#142621'; b.style.color = '#CDE2DB'; }
        });
        __fx.on(b, 'mouseleave', function(){
          ...
          if (isOutline){ b.style.backgroundColor = 'transparent'; b.style.color = '#142621'; }
        });
      });
    ...
    wireWeb3Form(__fx, { root: '#contact', subject: 'New inquiry — Contracts & Commercial', page: 'Contracts & Commercial' })
