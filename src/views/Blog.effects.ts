...
export function initEffects(): () => void {
  ...
  try {
    ...
    (function(){
      ...
      /* 4b. CYBERLINE SWEEP — data-anim="cpulse", themed per section */
      (function(){
      ...
      /* 5. HEX ROW SCROLL — data-anim="hexrow" */
      (function(){
      ...
      /* 6. SCROLL REVEALS — data-anim="reveal" (section heads + cards) */
      (function(){
        ...
        var targets = [].slice.call(document.querySelectorAll('[data-anim="reveal"]'));
        targets.forEach(function(el){ el.style.opacity='0'; el.style.transform='translateY(16px)'; });
