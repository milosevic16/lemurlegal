...
const c: Bilingual<CryptoLegalOpinionContent> = {
  en: {
    ...
    testimonials: {
      ...
      quotes: [
        { p: 'Thanks to Peter from Lemur Legal, we confidently navigated the crypto legal landscape, ensuring our project’s compliance and success, resulting in our BST token listing on MEXC. Great service.', by: 'Denis Petrovcic · Blocksquare.io' },
  ...
  sl: {
    ...
    testimonials: {
      ...
      quotes: [
        ...
        { p: 'Zahvaljujoč Petru iz Lemur Legal smo se samozavestno znašli v kripto pravnem okolju ter zagotovili skladnost in uspeh našega projekta, kar je pripeljalo do uvrstitve žetona BST na borzo MEXC. Odlična storitev.', by: 'Denis Petrovcic · Blocksquare.io' },
